package com.example.flowtestapplication.viewPager
...
import com.example.flowtestapplication.R

class ParallelNestedScrollingActivity : ComponentActivity() {
    ...
    inner class VpAdapter : RecyclerView.Adapter<VpAdapter.ViewHolder>() {
...
//                cv.setViewTreeSavedStateRegistryOwner(this@ParallelNestedScrollingActivity)
//                cv.setViewTreeLifecycleOwner(this@ParallelNestedScrollingActivity)
                cv.isNestedScrollingEnabled = true
                cv.isHorizontalScrollBarEnabled = true
                cv.setContent { Container() }
            }
        }
        ...
        inner class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
            ...
            val cv: ComposeView = itemView.findViewById(R.id.cv)
